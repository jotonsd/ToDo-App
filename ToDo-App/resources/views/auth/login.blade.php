@extends('layouts.app')
@section('title') Login to {{ config('app.name', 'Laravel') }} @stop
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><b>{{ __('Login to ToDo-App') }}</b></div>

                <div class="card-body">
                    <form method="POST" id="myform" action="{{ route('login') }}" novalidate>
                        @csrf
