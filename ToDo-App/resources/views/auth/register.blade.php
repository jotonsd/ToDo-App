@extends('layouts.app')
@section('title') Register to {{ config('app.name', 'Laravel') }} @stop
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><b>{{ __('Register to ToDo-App') }}</b></div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-registered" aria-hidden="true"></i>&nbsp;&nbsp;{{ __('Register') }}
                                </button>
                            </div>
                        </div>
                    </form>
